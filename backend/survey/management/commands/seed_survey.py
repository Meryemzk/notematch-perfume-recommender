...
PERFUME_DATA = [
    {"name": "Citrus Bloom", "brand": "NoteMatch", "notes": "citrus, bergamot, lemon, fresh musk", "moods": ["Energic"]},
    {"name": "Fresh Energy", "brand": "NoteMatch", "notes": "fresh, orange, green notes, clean musk", "moods": ["Energic"]},
    {"name": "Spice Confidence", "brand": "NoteMatch", "notes": "spicy ginger, pepper, amber, woody", "moods": ["Energic"]},
    {"name": "Lavender Calm", "brand": "NoteMatch", "notes": "lavender, soft musk, powdery notes", "moods": ["Relaxation"]},
    {"name": "Vanilla Comfort", "brand": "NoteMatch", "notes": "vanilla, amber, warm musk", "moods": ["Relaxation"]},
    {"name": "Woody Serenity", "brand": "NoteMatch", "notes": "sandalwood, cedar, musk, amber", "moods": ["Relaxation"]},
]
